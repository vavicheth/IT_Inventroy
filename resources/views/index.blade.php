                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h6 class="mb-0"><img src="{{ URL::asset('assets/images/users/user-3.jpg') }}" alt="" class="thumb-sm rounded-circle mr-2"> James Athey</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ URL::asset('assets/images/users/user-2.jpg') }}" alt="" class="thumb-md rounded-circle mr-2"> Philip Smead
                                                        </div>
                                                    </td>
                                                    <td>15/1/2018</td>
                                                    <td>$94</td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ URL::asset('assets/images/users/user-3.jpg') }}" alt="" class="thumb-md rounded-circle mr-2"> Brent Shipley
                                                        </div>
                                                    </td>
                                                    <td>16/1/2019</td>
                                                    <td>$112</td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ URL::asset('assets/images/users/user-4.jpg') }}" alt="" class="thumb-md rounded-circle mr-2"> Robert Sitton
                                                        </div>
                                                    </td>
                                                    <td>17/1/2019</td>
                                                    <td>$116</td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ URL::asset('assets/images/users/user-5.jpg') }}" alt="" class="thumb-md rounded-circle mr-2"> Alberto Jackson
                                                        </div>
                                                    </td>
                                                    <td>18/1/2019</td>
                                                    <td>$109</td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ URL::asset('assets/images/users/user-6.jpg') }}" alt="" class="thumb-md rounded-circle mr-2"> David Sanchez
                                                        </div>
                                                    </td>
                                                    <td>19/1/2019</td>
                                                    <td>$120</td>
                                            ...
                                            <ul class="conversation-list slimscroll" style="max-height: 400px;">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="{{ URL::asset('assets/images/users/user-2.jpg') }}" alt="male">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="{{ URL::asset('assets/images/users/user-3.jpg') }}" alt="Female">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="{{ URL::asset('assets/images/users/user-3.jpg') }}" alt="male">
                                                ...
                                                <li class="clearfix odd">
                                                    ...
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                            ...
                                                            <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" alt="" height="48px" class="rounded mr-2">
                                                            <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="" height="48px" class="rounded">
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
